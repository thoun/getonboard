 ...
 * states.inc.php
 *
 * GetOnBoard game states description
 *
 */
...
$playerActionsGameStates = [
    ...
    ST_PLAYER_PLACE_ROUTE => [
        ...
        "descriptionUseStation" => clienttranslate('${actplayer} can place a route with remaining circled stations'),
        "descriptionmyturnUseStation" => clienttranslate('${you} can place a route with remaining circled stations'),
        "descriptionConfirm" => clienttranslate('${actplayer} must confirm placed marker(s)'),
        "descriptionmyturnConfirm" => clienttranslate('${you} must confirm placed marker(s)'),
        "type" => "activeplayer",
        "args" => "argPlaceRoute",
        "possibleactions" => [ 
            "placeRoute",
