    ...
    */
    ...
    GetOnBoard.prototype.getTooltip = function (element) {
        switch (element) {
            ...
            case 20: return '[OldLady] : ' + _("When a marker reaches an [OldLady], check a box on the [OldLady] zone. Add the number next to each checked box at the end.");
            case 30: return '[Student] : ' + _("When a marker reaches an [Student], check a box on the [Student] zone. Multiply [Student] with [School] at the end.");
            case 32: return '[School] : ' + _("When a marker reaches a [School], check a box on the [School] zone. Multiply [Student] with [School] at the end.") + "<br><i>".concat(_("If the [School] is marked with a Star, write the number of [Student] you have checked when a marker reaches it."), "</i>");
            case 40: return '[Tourist] : ' + _("When a marker reaches a [Tourist], check a box on the first available row on the [Tourist] zone. You will score when you drop the [Tourist] to [MonumentLight]/[MonumentDark]. If the current row is full and you didn't reach [MonumentLight]/[MonumentDark], nothing happens.");
            ...
            case 50: return '[Businessman] : ' + _("When a marker reaches [Businessman], check a box on the first available row on the [Businessman] zone. You will score when you drop the [Businessman] to [Office]. If the current row is full and you didn't reach [Office], nothing happens.");
