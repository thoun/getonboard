    ...
    */
    ...
    private getTooltip(element: number) {
        switch (element) {
            ...
            case 32: return '[School] : ' + _("When a marker reaches a [School], check a box on the [School] zone. Multiply [Student] with [School] at the end.") + `<br><i>${_("If the [School] is marked with a Star, write the number of [Student] you have checked when a marker reaches it.")}</i>`;
