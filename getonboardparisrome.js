...
var TableCenter = /** @class */ (function () {
    ...
    TableCenter.prototype.placeCommonObjective = function (objective, isPlayer) {
        ...
        this.game.addTooltipHtml("common-objective-slot-".concat(objective.number), "".concat(this.game.getTooltip(90), "<br><br>").concat(_("To complete this objective, you need to check ${number} ${element}").replace('${number}', "<strong>".concat(commonObjectiveInfos[1], "</strong>")).replace('${element}', commonObjectiveInfos[0] == 50 ? "<div class=\"map-icon\" data-element=\"50\"></div>/<div class=\"map-icon\" data-element=\"51\"></div>" : "<div class=\"map-icon\" data-element=\"".concat(commonObjectiveInfos[0], "\"></div>"))));
